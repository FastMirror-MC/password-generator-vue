...
<template>
  <main>
    ...
    <div class="flex flex-col gap-2">
      <div class="input-wrapper">
        <label id="label-ignore" class="label">
          排除字符：
        </label>
